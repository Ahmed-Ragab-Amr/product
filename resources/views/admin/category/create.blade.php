              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">إضافة صنف جديد</h5>
                </div>
                    <!-- الحقول -->
                    <form action="{{ route('category.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="sectionName" placeholder="أدخل اسم الصنف">
                          </div>
                      ...
                      <button type="submit" class="btn btn-primary w-100">إضافة الصنف</button>
                    </form>
